...
_script_sh_completion() {
    ...
    SCRIPT_OPTIONS="install observing_squad multikey_group upgrade upgrade_multikey upgrade_squad upgrade_proxy remove_db start start_all stop stop_all cleanup github_pull add_nodes get_logs benchmark quit"
